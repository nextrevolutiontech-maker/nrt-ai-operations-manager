...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var permissions, adminRole, _i, permissions_1, permName, perm, existingLink;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    permName = permissions_1[_i];
                    return [4 /*yield*/, prisma.permission.findFirst({ where: { name: permName } })];
                case 3:
                    perm = _a.sent();
                    if (!!perm) return [3 /*break*/, 5];
                    return [4 /*yield*/, prisma.permission.create({
                            data: { name: permName, description: "Auto-generated permission: ".concat(permName) }
                        })];
                case 4:
                    perm = _a.sent();
                    console.log("Created permission: ".concat(permName));
                    _a.label = 5;
                case 5: return [4 /*yield*/, prisma.rolePermission.findFirst({
                        where: { roleId: adminRole.id, permissionId: perm.id }
                    })];
                case 6:
                    existingLink = _a.sent();
                    if (!!existingLink) return [3 /*break*/, 8];
                    return [4 /*yield*/, prisma.rolePermission.create({
                            data: { roleId: adminRole.id, permissionId: perm.id }
                        })];
                case 7:
                    _a.sent();
                    console.log("Assigned ".concat(permName, " to Admin role"));
                    _a.label = 8;
                case 8:
                    _i++;
                    return [3 /*break*/, 2];
