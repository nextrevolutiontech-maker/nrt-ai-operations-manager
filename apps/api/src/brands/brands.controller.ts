...
export class BrandsController {
  ...
  create(@Body() createBrandDto: CreateBrandDto, @Request() req: any) {
    return this.brandsService.create(req.user.companyId, req.user.id, createBrandDto);
  }
  ...
  update(@Param('id') id: string, @Body() updateBrandDto: UpdateBrandDto, @Request() req: any) {
    return this.brandsService.update(req.user.companyId, id, req.user.id, updateBrandDto);
  }
