...
export function SalesOrderForm({ onSubmit, isLoading }: SalesOrderFormProps) {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Issuing Warehouse *</label>
            <select
          ...
          <FormInput
            label="Delivery Date"
            type="date"
            registration={register('deliveryDate')}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50 text-sm">
                ...
                <th className="p-3 font-medium text-slate-600 w-32">Unit Price *</th>
                    ...
                    <td className="p-2">
                      ...
                      >
                        ...
                        {products?.items?.map((p: any) => (
                          <option key={p.id} value={p.id}>{p.sku} - {p.name} (Stock: {p.currentStock || 0})</option>
                        ))}
                      </select>
                    </td>
                    <td className="p-2">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        ...
        <textarea
          ...
          rows={3}
          placeholder="Enter any internal notes or terms for the customer..."
        />
      </div>
